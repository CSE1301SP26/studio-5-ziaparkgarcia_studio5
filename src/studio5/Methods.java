...
public class Methods {
	...
	public static double distanceBetween(double x1, double y1, double x2, double y2) {
		double innerx2 = Math.pow(x1 - x2, 2);
		double innery2 = Math.pow(y1 - y2, 2);
		double distance = Math.sqrt(innerx2 + innery2);
	 ...
	 * Return an array of a given size filled with the provided value
	 * 
	 * @param value array that we are taking in
	 * @return double and array of size that's filled with value
	 */
